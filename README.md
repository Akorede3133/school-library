...
```sh
 git clone https://github.com/Akorede3133/school-library.git
 cd school-library
```
...
- GitHub: [@wineshugea](https://github.com/Akorede3133)
- Twitter: [@wineshuga](https://twitter.com/SaheedAkorede7)
...
Feel free to check the [issues page](https://github.com/Akorede3133/school-library/issues).
